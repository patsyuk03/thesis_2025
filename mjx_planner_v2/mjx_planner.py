...
class cem_planner():
	...
	def compute_cem(self, init_pos=jnp.array([1.5, -1.8, 1.75, -1.25, -1.6, 0]), init_vel=jnp.zeros(6)):
...
def main():
	...
	cost, best_cost_g, best_vels, best_traj = opt_class.compute_cem(jnp.array([1.5, -1.8, 1.75, -1.25, -1.6, 0]), jnp.array([0]*6))
